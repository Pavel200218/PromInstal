...
(window.t_forms__lang = (window.navigator.userLanguage || window.navigator.language).toUpperCase().slice(0, 2)),
    ...
    (window.tildaForm_customMasksLoad = function () {
        ...
        !0 !== window.isInitEventsCustomMask &&
            (((t = document.createElement("script")).type = "text/javascript"), (t.src = "https://static.tildacdn.com/js/tilda-forms-custommask-1.0.min.js"), document.head.appendChild(t), (window.isInitEventsCustomMask = !0));
    }),
    ...
    (window.tildaForm.validate = function (t) {
        ...
        for (var e, r, o = t.querySelectorAll(".js-tilda-rule"), a = [], n = !0, i = 0; i < o.length; i++) {
            ...
            (f.obj = s),
                (f.type = []),
                _ && _.length && ((y = _.replace(/[\s\u0000—\u001F\u2000-\u200F\uFEFF\u2028-\u202F\u205F-\u206F]/gi, "")), (_ = _.trim())),
                0 < _.length && (n = !1),
                (m = m && parseInt(m, 10)),
                (p = p && parseInt(p, 10));
                ...
                for (var _ = 0; _ < e[p].type.length; _++) {
                    ...
                    (r = t.querySelector(".js-rule-error-" + y))
                        ? (r.textContent && r.innerText) || !w || -1 !== d.indexOf(w)
                            ? ((l = r.textContent || r.innerText), -1 === d.indexOf(w) && (d = d + '<p class="t-form__errorbox-item">' + l + "</p>"))
                            : (d = d + '<p class="t-form__errorbox-item">' + w + "</p>")
                        : w && -1 === d.indexOf(w) && (d = d + '<p class="t-form__errorbox-item">' + w + "</p>"),
                        i &&
                            (!l && t_forms__getMsg(y + "field") ? (l = t_forms__getMsg(y + "field")) : w && (l = w),
                            l &&
                                n &&
