...
function t_menu__setBGcolor(e, t) {
    ...
    Array.prototype.forEach.call(n, function (e) {
        window.innerWidth > 980
            ? "yes" === e.getAttribute("data-bgcolor-setbyscript") && (e.style.backgroundColor = e.getAttribute("data-bgcolor-rgba"))
            : ((e.style.backgroundColor = e.getAttribute("data-bgcolor-hex")), e.setAttribute("data-bgcolor-setbyscript", "yes"), e.style.transform && (e.style.transform = ""), e.style.opacity && (e.style.opacity = ""));
    });
}
    ...
    if (!(window.innerWidth <= 980) || r) {
        ...
        Array.prototype.forEach.call(o, function (e) {
            ...
            (e.style.backgroundColor = window.pageYOffset > 20 ? n : t),
                (window.pageYOffset > 20 && "0" === i) || (window.pageYOffset <= 20 && "0.0" === r) || " " === o ? (e.style.boxShadow = "none") : (e.style.boxShadow = "0px 1px 3px rgba(0,0,0," + a + ")");
        });
    }
}
...
function t_menu__FadeOut(e, t, n) {
    ...
    var i,
        o = setInterval(
            function () {
                (e.style.opacity = r), (r -= 0.1) <= 0.1 && ((e.style.opacity = "0"), (e.style.display = "none"), "function" == typeof n && n(), clearInterval(o));
            },
            t > 0 ? t / 10 : 40
        );
}
function t_menu__fadeIn(e, t, n) {
    ...
    var o = setInterval(function () {
        (e.style.opacity = r), (r += 0.1) >= 1 && ((e.style.opacity = "1"), "function" == typeof n && n(), clearInterval(o));
    }, i);
}
