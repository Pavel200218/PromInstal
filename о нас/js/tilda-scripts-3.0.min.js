...
function t_scrollBarWidthCompensator__init() {
    ...
    var t,
        e,
        r,
        d = window.scrollBarWidthCompensator;
    (d.scrollBarWidth = Math.abs(window.innerWidth - document.documentElement.clientWidth)),
        !d.isInited &&
            d.scrollBarWidth &&
            ((d.isInited = !0),
            ...
            (document.body.style.paddingRight = d.scrollBarWidth + t + "px"),
            (document.body.style.height = "100vh"),
            (document.body.style.minHeight = "100vh"),
            (document.body.style.overflow = "hidden"),
            (r = []),
            Array.prototype.forEach.call(d.fixedElements, function (t) {
                var e,
                    n,
                    i,
                    o,
                ...
                !document.body.contains(a) ||
                    ...
                    a.classList.contains("t975") ||
                    ("fixed" !== (e = (i = t.computedStyle).getPropertyValue("position")) && "absolute" !== e) ||
                    ((o = i.getPropertyValue("transition-duration")).indexOf("ms") + 1 ? ((o = parseInt(o.replace("ms", ""), 10)), r.push(o)) : o.indexOf("s") + 1 && ((o = 1e3 * parseFloat(o.replace("s", ""))), r.push(o)),
                    (n = i.getPropertyValue("right")),
                    (n = parseInt(n.replace("px", ""), 10)),
                    (t = i.getPropertyValue("width")),
                    (o = i.getPropertyValue("height")),
                    (i = a.style.right) && a.setAttribute("data-tilda-initial-right", i),
                    (i = a.style.width) && a.setAttribute("data-tilda-initial-width", i),
                    (t = "100%" === t || t === window.innerWidth + "px" || t === window.innerWidth - d.scrollBarWidth + "px" || "100vw" === t),
                    (o = "100%" === o || o === window.innerHeight + "px" || o === window.innerHeight - d.scrollBarWidth + "px" || "auto" === o || "100vh" === o),
                    (!n && 0 !== n) || "auto" === a.style.right || "absolute" === e || t ? t && !o && (a.style.width = "calc(100vw - " + d.scrollBarWidth + "px)") : (a.style.right = d.scrollBarWidth + n + "px"));
            }),
...
(window.isSearchBot = !1),
    ...
    t_onReady(function () {
        ...
        -1 !== t.indexOf("Android") &&
            (n || e || i || o || a) &&
            (((o = document.createElement("p")).style.lineHeight = "100px"),
            (o.style.padding = "0"),
            (o.style.margin = "0"),
            (o.style.height = "auto"),
            (o.style.position = "absolute"),
            (o.style.opacity = "0.001"),
            (o.innerText = "abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ"),
            document.body.appendChild(o),
            (a = 100 / o.getBoundingClientRect().height),
            o.parentNode.removeChild(o),
            a < 0.98 && document.body.insertAdjacentHTML("beforeend", '<style>.t396 [data-elem-type="text"] .tn-atom {zoom: ' + 100 * a + "%;}</style>")),
        ...
        if (!window.isMobile && t && "yes" !== t.getAttribute("data-blocks-animationoff") && !1 === window.isSearchBot) {
            ...
            for (
                var o,
                    ...
                    r,
                    d,
                    l = Array.prototype.slice.call(e).filter(function (t) {
                ...
                var s,
                    c = (s = l[n]).getBoundingClientRect().top + window.pageYOffset,
            ...
            function h() {
                for (var t = l.length - 1; 0 <= t; t--) {
                    ...
                    e.getBoundingClientRect().top + window.pageYOffset < (e.offsetHeight <= 100 ? window.pageYOffset + window.innerHeight : window.pageYOffset + window.innerHeight - 100) &&
                        (t_removeClass(e, "r_hidden"), t_addClass(e, "r_showed"), (l = Array.prototype.slice.call(l)).splice(t, 1));
                }
            }
            l.length &&
    ...
    (function () {
        ...
        function t() {
            for (var t, e, n, i, o = document.querySelectorAll(".t-cover__carrier"), a = 0, r = 0; r < o.length; r++)
                -1 < (l = (d = o[r]).style).height.indexOf("vh") &&
                    ((a = parseInt(l.height, 10) / 100),
                    ...
                    (i = parseInt(getComputedStyle(n).height.replace("px", ""))),
                    t_removeEl(n),
                    (t = Math.round(i * a) + "px"),
                    (e = d.closest(".t-cover")) && ((n = e.querySelector(".t-cover__filter")), (i = e.querySelector(".t-cover__wrapper")), (e.style.height = t), n && (n.style.height = t), i && (i.style.height = t)),
                    (l.height = t));
            for (var d, l, s = document.querySelectorAll("[data-height-correct-vh]"), c = window.innerHeight, a = 0, r = 0; r < s.length; r++)
                -1 < (l = (d = s[r]).style).height.indexOf("vh") && ((a = parseInt(l.height) / 100), (t = c + "px"), (l.height = t));
        }
        function e() {
