            ...
            if (!sliderWrapper.getAttribute("data-slider-initialized")) {
                ...
                if (sliderItems) {
                    ...
                    if (
                        ...
                        return !1;
                    isNaN(sliderTransition) && sliderWrapper.setAttribute("data-slider-transition", "300"),
                    ...
                    var userAgent = window.navigator.userAgent,
                        ...
                        ieVersion = "",
                        oldIE = !1;
                    Idx > 0 && ((8 != (ieVersion = parseInt(userAgent.substring(Idx + 5, userAgent.indexOf(".", Idx)))) && 9 != ieVersion) || (oldIE = !0)),
                        !0 === oldIE &&
                        ...
                        sliderWrapper.getAttribute("data-slider-totalslides") || sliderWrapper.setAttribute("data-slider-totalslides", totalSlides);
                    var sliderPosition = sliderWrapper.getAttribute("data-slider-pos");
                    sliderPosition ? (position = parseInt(sliderPosition, 10)) : sliderWrapper.setAttribute("data-slider-pos", 1),
                        ...
                        isFeedsSlider || t_slds__createDummies(firstSlide, lastSlide, sliderWrapper),
                        (itemsInRow = parseInt(sliderWrapper.getAttribute("data-slider-items-in-row"), 10) || 0);
                    ...
                    arrowRight.length > 0 &&
                        ...
                        sliderRec.querySelectorAll(".t-slds__item-loaded").length < totalSlides + 2 && t_slds_UpdateImages(rec, position),
                        "yes" == sliderWrapper.getAttribute("data-slider-arrows-nearpic") && t_slds_positionArrows(rec);
...
function t_slds__createDummies(firstSlide, lastSlide, sliderWrapper) {
    var sliderItems,
        totalSlides = sliderWrapper.querySelectorAll(".t-slds__item:not(.t-slds__item_dummy)").length,
        itemsInRow = parseInt(sliderWrapper.getAttribute("data-slider-items-in-row"), 10) || 0,
        sliderWithCycle = sliderWrapper.getAttribute("data-slider-with-cycle"),
    ...
    restoreAttrClassFirst && (firstSlideImgwrapper.classList.add("t-zoomable"), firstSlideImgwrapper.setAttribute("data-zoomable", "yes")),
        restoreAttrClassLast && (lastSlideImgwrapper.classList.add("t-zoomable"), lastSlideImgwrapper.setAttribute("data-zoomable", "yes"));
}
function t_slds__hideMobileSlides(activeSlide) {
    if (activeSlide) {
        ...
        if (!(slides.length <= 2 * maxSlidesViewed)) {
            for (var activeSlideIndex = activeSlide.getAttribute("data-slide-index"), activeIndexList = [(activeSlideIndex = parseInt(activeSlideIndex, 10))], i = 1; i < maxSlidesViewed; i++)
                activeSlideIndex + i <= slides.length ? activeIndexList.push(activeSlideIndex + i) : activeIndexList.push(i),
                    activeSlideIndex - i > 0 ? activeIndexList.push(activeSlideIndex - i) : activeIndexList.push(slides.length + 1 - i);
    ...
    if (sliderRec) {
        ...
        if (sliderWrapper)
            (sliderWrapper.getAttribute("data-slider-items-in-row") || 0) &&
                ...
                updatedItemsInRow && sliderWrapper.setAttribute("data-slider-items-in-row", updatedItemsInRow);
    }
}
        ...
        if (sliderWrapper) {
            ...
            if ((position > totalSlides + 1 && (position = 1), sliderNotAnimated)) {
                ...
                if (activeSlide && 0 === sliderRec.querySelectorAll(".t-slds__item_dummy").length) {
                    ...
                    if ((dummy.classList.add("t-slds__item_dummy"), (dummy.style.position = "absolute"), (dummy.style.left = sliderWidth * position + "px"), sliderWrapper.appendChild(dummy), sliderRec.classList.contains("js-product")))
                        catalog = sliderRec;
        ...
        if (sliderWrapper) {
            ...
            if (arrowWrapperRight)
                if (isFeedsSlider) {
                    ...
                    "false" == sliderWrapper.getAttribute("data-slider-with-cycle") && (position == totalSlides || (itemsInRow > 1 && position == totalSlides - itemsInRow + 1))
                        ? t_slds_fadeOut(arrowWrapperRight, 300)
                        : t_slds_fadeIn(arrowWrapperRight, 300);
            arrowWrapperLeft && ("false" == sliderWrapper.getAttribute("data-slider-with-cycle") && 1 == position ? t_slds_fadeOut(arrowWrapperLeft, 300) : t_slds_fadeIn(arrowWrapperLeft, 300)),
                ...
                setTimeout(function () {
                    sliderWrapper.classList.remove("t-slds_animated"),
                        sliderWrapper.setAttribute("data-slider-animated", ""),
                        "yes" == (cycle = sliderWrapper.getAttribute("data-slider-cycle")) &&
                            (position == totalSlides + 1 && (position = 1),
                            0 == position && (position = totalSlides),
                            safariMajorVersion >= 13 && isiOSChrome && !sliderNotAnimated ? t_slide_MoveAnimation(sliderWrapper, position, sliderWidth, 0) : (sliderWrapper.style.transform = "translateX(-" + sliderWidth * position + "px)"),
                            !0 !== sliderNotAnimated && t_slds_ActiveSlide(rec, position, totalSlides, sliderOptions),
                            sliderWrapper.setAttribute("data-slider-pos", position)),
                        ("y" === window.lazy || (document.querySelector("#allrecords") && "yes" === document.querySelector("#allrecords").getAttribute("data-tilda-lazy"))) &&
                            t_slds_onHammerLoad("t_lazyload_update", function () {
                                t_lazyload_update();
                            }),
    ...
    if (sliderRec) {
        ...
        if (sliderWrapper) {
            var itemsInRow = sliderWrapper.getAttribute("data-slider-items-in-row") || 0,
                ...
                sliderWithCycle = sliderWrapper.getAttribute("data-slider-with-cycle"),
                arrowWrapperRight = sliderRec.querySelector(".t-slds__arrow_wrapper-right");
            position > totalSlides + 1 && ((position = 1), sliderWrapper.setAttribute("data-slider-pos", 1)),
                arrowWrapperRight && (arrowWrapperRight.style.display = "false" === sliderWithCycle && (totalSlides - itemsInRow <= 0 || position === totalSlides) ? "none" : ""),
                (sliderWrapper.style.transform = "translateX(-" + sliderWidth * position + "px)"),
                "true" == sliderWrapper.getAttribute("data-slider-correct-height") && t_slds_UpdateSliderHeight(rec),
...
function t_slds_UpdateImages(rec, position) {
    ...
    if (sliderRec) {
        ...
        item &&
            ...
            item.nextElementSibling && item.nextElementSibling.classList.add("t-slds__item-loaded"),
            item.previousElementSibling && item.previousElementSibling.classList.add("t-slds__item-loaded"));
    }
}
    ...
    if (sliderRec) {
        ...
        Array.prototype.forEach.call(captions, function (caption) {
            ...
            0 == position
                ...
                : position == totalSlides + 1 && (captionActive = sliderRec.querySelector('.t-slds__caption[data-slide-caption="1"]')),
...
function t_slds_ActiveBullet(rec, position, totalSlides, sliderOptions) {
    ...
    if (sliderRec) {
        ...
        Array.prototype.forEach.call(bullets, function (bullet) {
            ...
            (sliderOptions && sliderOptions.thumbsbulletGallery && position >= maxThumbsCount && position != totalSlides + 1) || (totalSlides >= maxThumbsCount && 0 == position)
                ...
                : position == totalSlides + 1 && (bulletActive = sliderRec.querySelector('.t-slds__bullet[data-slide-bullet-for="1"]')),
    ...
    if (sliderRec) {
        ...
        if (
            (Array.prototype.forEach.call(iframes, function (iframe) {
                iframe.src &&
                    (-1 !== iframe.src.indexOf("&enablejsapi=1") && iframe.contentWindow.postMessage('{"event":"command","func":"pauseVideo","args":""}', "*"),
                    -1 === iframe.src.indexOf("vimeo") || (-1 === iframe.src.indexOf("&amp;api=1") && -1 === iframe.src.indexOf("&api=1")) || iframe.contentWindow.postMessage('{"method":"pause","value":"true"}', "*"));
            }),
    ...
    if (sliderRec) {
        ...
        if (sliderContainer) {
            ...
            if (itemWidth > 0) {
                ...
                sliderWrapper && (items = sliderWrapper.querySelectorAll(".t-slds__item")),
                    Array.prototype.forEach.call(items, function (item) {
        ...
        if (sliderWrapper) {
                    ...
                    function () {
                        if (document[hidden]) sliderWrapper.setAttribute("data-slider-stopped", "yes");
                            ...
                            (elementTop = sliderRec.getBoundingClientRect().top + window.pageYOffset),
                                (elementBottom = elementTop + sliderRec.offsetHeight) > viewportTop &&
                                    elementTop < viewportBottom &&
                                    "none" !== display &&
                                    "y" !== sliderWrapper.getAttribute("data-slider-stopped-by-video") &&
                ...
                1 === sliderRec.length &&
                    window.bind(
                        ...
                        t_throttle(function () {
                            ...
                            "none" !== display
                                ? ((elementTop = sliderRec.getBoundingClientRect().top + window.pageYOffset),
                                  (elementBottom = elementTop + sliderRec.offsetHeight) > viewportTop && elementTop < viewportBottom && "y" !== sliderWrapper.getAttribute("data-slider-stopped-by-video")
                                      ? sliderWrapper.setAttribute("data-slider-stopped", "")
                                      : "" === sliderWrapper.getAttribute("data-slider-stopped") && sliderWrapper.setAttribute("data-slider-stopped", "yes"))
                                : isZeroBlock || sliderWrapper.setAttribute("data-slider-stopped", "yes");
                        })
                    );
            var galleryIntervalId = setInterval(function () {
                ...
                "yes" != stopped &&
                    "yes" != ignorehover &&
                    "yes" != isSliderTouch &&
                    ("false" == sliderWrapper.getAttribute("data-slider-with-cycle") && position == totalSlides ? (position = totalSlides) : position++,
                    sliderWrapper.setAttribute("data-slider-pos", position),
                    (position != totalSlides + 1 && 0 != position) || (cycle = "yes"),
                    t_slideMoveWithoutAnimation(rec, !0, sliderOptions, currentTranslate),
                    t_slds_updateSlider(rec),
                    "yes" == cycle && (position == totalSlides + 1 && (position = 1), 0 == position && (position = totalSlides), sliderWrapper.setAttribute("data-slider-pos", position)),
                    sliderWrapper.setAttribute("data-slider-cycle", cycle));
            }, sliderTimeOut);
        ...
        if (sliderMain) {
            ...
            if (sliderWrapper) {
                ...
                var stopSliderIfNeed = function (stopAttribute) {
                        window.pageYOffset > sliderRec.getBoundingClientRect().bottom + window.pageYOffset || window.pageYOffset + document.documentElement.clientHeight < sliderRec.getBoundingClientRect().top + window.pageYOffset
                            ? sliderWrapper.setAttribute(stopAttribute, "yes")
                            : "y" !== sliderWrapper.getAttribute("data-slider-stopped-by-video") && sliderWrapper.setAttribute(stopAttribute, "");
                    },
                    ...
                    hammer.on("pan", function (event) {
                        ...
                        if ((sliderWrapper.setAttribute("data-slider-touch", "yes"), t_slds_scrollImages(rec, sliderWidth * position - distance), event.isFinal)) {
                            if (event.velocityX > 0.4)
                                "false" == sliderWrapper.getAttribute("data-slider-with-cycle") && 1 == position ? (position = 1) : position--,
                                    sliderWrapper.setAttribute("data-slider-pos", position),
                                    0 == position && (cycle = "yes"),
                                    sliderWrapper.setAttribute("data-slider-cycle", cycle),
                                    t_slideMove(rec, !1, sliderOptions);
                            else if (event.velocityX < -0.4) {
                                if ("false" == sliderWrapper.getAttribute("data-slider-with-cycle") && (position == totalSlides || (withSingleMove && position == totalSlides - itemsInRow + 1)))
                                ...
                                percentage <= -30 / totalSlides
                                    ? ("false" == sliderWrapper.getAttribute("data-slider-with-cycle") && (position == totalSlides || (withSingleMove && position == totalSlides - itemsInRow + 1))
                                          ? (position = withSingleMove ? totalSlides - itemsInRow : totalSlides)
                                          : position++,
                                      sliderWrapper.setAttribute("data-slider-pos", position),
...
function t_slds_changeImageUrl(rec) {
    var allRec = document.getElementById("allrecords"),
        ...
        imgs;
    sliderRec &&
        ((imgs = isLazyActive ? sliderRec.querySelectorAll(".t-slds__img:not([data-original])") : sliderRec.querySelectorAll(".t-slds__img")),
...
function t_slds_fadeOut(el, duration, complete) {
    if ("none" !== el.style.display && !el.getAttribute("data-fadeout-timeout")) {
        ...
        var speed,
            timer = setInterval(
                function () {
                    (el.style.opacity = opacity), (opacity -= 0.1) <= 0.1 && (clearInterval(timer), el.removeAttribute("data-fadeout-timeout"), (el.style.display = "none"), "function" == typeof complete && complete());
                },
...
function t_slds_fadeIn(el, duration, complete) {
    if ((("1" !== getComputedStyle(el).opacity && "" !== getComputedStyle(el).opacity) || "none" === getComputedStyle(el).display) && !el.getAttribute("data-fadein-timeout")) {
        ...
        var timer = setInterval(function () {
            (el.style.opacity = opacity), (opacity += 0.1) >= 1 && (clearInterval(timer), el.removeAttribute("data-fadein-timeout"), "function" == typeof complete && complete());
        }, speed);
