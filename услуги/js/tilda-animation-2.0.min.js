...
function t_animate__getMediaQuery(t, e) {
    var a = "",
        ...
        o = e === t.length - 1,
        t = e === t.length - 2;
    return o ? (n = !0) : (a += t ? "@media screen and (max-width: " + r + "px) {" : "@media screen and (min-width: " + i + "px) and (max-width: " + r + "px) {"), { text: a, isContinue: n, minRes: i };
}
                          ...
                          new IntersectionObserver(function (t, a) {
                              t.forEach(function (t) {
                                  ...
                                  t.isIntersecting &&
                                      ((e = t.target),
                                      a.unobserve(e),
                                      (t = e.closest(".r").querySelectorAll(".t-animate")),
                          ...
                          e = new IntersectionObserver(function (t, n) {
                              t.forEach(function (t) {
                                  ...
                                  !a.demandTransform && a.style.transform
                                      ...
                                      t.isIntersecting &&
                                          (n.unobserve(a),
                                          (t = -1 !== (t = a.style.transitionDelay || "0ms").indexOf("ms") ? parseInt(t) + 250 : 1e3 * parseFloat(t) + 250),
        ...
        Array.prototype.forEach.call(r, function (t) {
            ...
            t.querySelectorAll('div[data-customstyle="yes"]').length
                ? ((e = (a = t.querySelector('div[data-customstyle="yes"]')) ? a.innerHTML : ""),
                  ...
                  (a = (a = t.querySelector("div[data-customstyle]")) ? a.getAttribute("style") : "") && (n += a),
...
function t_animate__animateNumbers(e) {
    ...
    var c,
        ...
        f,
        u,
        y = e.querySelector(".t-animate__number");
    r[0] &&
        ((c = Number(r[0]) || 0),
        (_ = 0),
        (d = Math.pow(10, s)),
        ...
        (u = setInterval(function () {
            var t;
            (_ += c / 108),
                (f = l ? (Math.round(_) / d).toFixed(s) + "" : Math.floor(_) + ""),
...
function t_animate__setAnimELemsState(t, n, i) {
    t.forEach(function (t) {
        ...
        t_animate__setCustomAnimSettings(t, e, i),
            e < a && (t_animate__removeNoHoverClassFromBtns(t), t.classList.add("t-animate_started"), "animatednumber" === t_animate__getAttrByResBase(t, "style") && t_animate__animateNumbers(t)),
...
function t_animate__assignOrderedElemsDelay(t, e) {
    ...
    n.length &&
        ...
        (n.length || i.length || r.length || o.length || s.length || l.length || m.length || e.length) &&
            t.length &&
