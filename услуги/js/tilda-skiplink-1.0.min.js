function t_skiplink__addButton() {
    ...
    t &&
        (t.querySelector("#t-header") || t.querySelector(".t-rec").querySelector('[data-menu="yes"]')) &&
        ((e = '<a href="#t-main-content" class="t-skiplink" aria-label="' + t_skiplink__dict("skiplinkAriaLabel") + '">' + t_skiplink__dict("skiplink") + "</a>"),
...
function t_skiplink__dict(e) {
    var t = [];
    (t.skiplink = { EN: "To main content", RU: "К основному контенту" }), (t.skiplinkAriaLabel = { EN: "Skip to main content", RU: "К основному контенту" });
